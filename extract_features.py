...
dropfile_feature = ["executable","text", "html", "image","xml","$WinREAgent", "OneDriveTemp", "PerfLogs", "Program Files", "Program Files(x86)", "ProgramData","Windows",  "$RECYCLE.BIN", "Users"]
...
converse_to_csv("input_demo_suci","final_demo_ver_suci.csv")
